		...
		<div class="wrap">
			...
			<div class="container">
				<div class="container-wrap">
					<?php
						include'../connect.php';
						$sql_xemhd="SELECT *FROM hoa_don where TrangThai='Đã Thanh Toán'" ;
					...
					<div>
						<ul class="list-item-wrap">
							<li>
								<a class="btn btn-primary" href="donhangdanggiao.php" role="button">Xem Đơn Hàng Đang Giao</a>
							</li>
							<li>
								<a class="btn btn-primary" href="#" role="button">Xem Đơn Hàng Đã Giao</a>
							</li>
							<li>
					  ...
					  <tbody>
					    <tr>
					      ...
					      <td>
					      	...
					      	<a class="btn btn-primary" href="duyetdonhang.php?id=<?php echo $data['MaHD']?>" role="button">Về Lại Đơn Đang Giao</a>
					      </td>			     	     
					    </tr>				    
					  </tbody>
					  	<?php
