	...
	<body>
		...
		<div class="wrap">
			...
			<div class="container">
					<?php
						include'../connect.php';
						$sql_xemdg="SELECT *FROM danh_gia" ;
					...
					?>
					  <tbody>
					    <tr>
					      ...
					      <td>
					      	<a class="btn btn-primary" href="xoadanhgia.php?id=<?php echo $data['MaDG']?>" role="button">Xoá</a>
					      	<a class="btn btn-primary" href="duyetdanhgia.php?id=<?php echo $data['MaDG']?>" role="button">Duyệt</a>
					      </td>			     	     
					    </tr>				    
					  </tbody>
					  	<?php
