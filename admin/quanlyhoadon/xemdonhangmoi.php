		...
		<div class="wrap">
			...
			<div class="container">
				<div class="container-wrap">
					<?php
						include'../connect.php';
						$sql_xemhd="SELECT *FROM hoa_don where TrangThai='chờ Duyệt'" ;
					...
					<div>
						<ul class="list-item-wrap">
							...
							<li>
								<a class="btn btn-primary" href="#" role="button">Xem Đơn Hàng Mới</a>
							</li>
						</ul>
					</div>
					  ...
					  <tbody>
					    <tr>
					      ...
					      <td>
					      	...
					      	<a class="btn btn-primary" href="duyetdonhang.php?id=<?php echo $data['MaHD']?>" role="button">Duyệt</a>
					      </td>			     	     
					    </tr>				    
					  </tbody>
					  	<?php
