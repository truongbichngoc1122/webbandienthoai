	...
	<body>
		...
		<div class="wrap">
			...
			<div class="container">
					<?php
						include'../connect.php';
						$sql_xemsp="SELECT *FROM san_pham" ;
				...
				<div class="container-wrap">
					...
					<a href="themmoisanpham.php" class="btn btn-primary btn-lg active mb-16" role="button" aria-pressed="true">Thêm Mới</a>
					<table class="table table-bordered">
					  ...
					  <thead>
					    <tr>
					      ...
					      <th scope="col">Tỷ Lệ Khuyến Mãi</th>
					...
					?>
					  <tbody>
					    <tr>
					      <th scope="row"><?php echo $data['MaSP'];?></th>
					      ...
					      <td>
					      	<a class="btn btn-primary" href="suasanpham.php?id=<?php echo $data['MaSP']?>" role="button">Sửa</a>
					      	<a class="btn btn-primary" href="xoasanpham.php?id=<?php echo $data['MaSP']?>" role="button">Xoá</a>
					      </td>			     	     
					    </tr>				    
					  </tbody>
					  	<?php
